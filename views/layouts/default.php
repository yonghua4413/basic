            ...
            <ul class="nav metismenu" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element"> <span>
                            <img style="width: 60px; height:60px;" alt="image" class="img-circle" src="/assets/img/admin.jpg" />
                             </span>
                    ...
                    <?php if($v['type'] == 'page'):?>
                    <li <?php if( isset($this->context->data['pcode']) && ( $this->context->data['pcode'] == $v['pcode']) ){echo 'class="active"';}?>>
                    ...
                    <li <?php if( isset($this->context->data['pcode']) && ( $this->context->data['pcode'] == $v['pcode']) ){echo 'class="active"';}?>>
                        ...
                        <ul class="nav nav-second-level collapse">
                            ...
                            <li <?php if( isset($this->context->data['code']) && ( $this->context->data['code'] == $val['code']) ){echo 'class="active"';}?>>
